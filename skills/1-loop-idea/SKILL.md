...
6. **Success Metric** — How would you know if this worked? What would "good" look like?
7. **Trade-offs** — What would you be willing to sacrifice to make this work?
8. **Scope** — Is this a weekend project, a business, a tool, a service, a movement?
9. **Timeline** — When would this exist and who would have access first?
10. **Constraints** — Any hard limits (budget, time, resources, regulations)?

**Pacing:**
- Ask 6–10 questions total, depending on idea complexity and user engagement
- Watch for signs they're ready to write: "I think I've got this" or decreasing novelty in answers
- After 8–10 questions, propose moving to writing phase
...
- **Structure** (adapt as needed):
  ...
  5. **In Summary** — A closing paragraph that ties it together
